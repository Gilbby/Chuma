...
export const notifications: Notice[] = [
  ...
  },
  {
    ...
    body: "A late contribution penalty of K25.00 has been issued by Lusaka Market Sisters.",
    date: "Today, 10:00",
    read: false,
    penaltyAmount: 25,
    penaltyReason: "Late contribution",
    groupId: "g1",
    groupName: "Lusaka Market Sisters",
  },
  {
    ...
    type: "penalty",
    title: "Penalty issued",
    body: "A missing meeting penalty of K50.00 has been issued by Kabwata Youth Savers.",
    date: "Today, 08:30",
    read: false,
    penaltyAmount: 50,
    penaltyReason: "Missing meeting",
    groupId: "g2",
    groupName: "Kabwata Youth Savers",
  },
